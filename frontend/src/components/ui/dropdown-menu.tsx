...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    {...props}
    onSelect={(e) => {
      // Execute original onSelect handler
      props.onSelect?.(e);
    }}
  />
));
